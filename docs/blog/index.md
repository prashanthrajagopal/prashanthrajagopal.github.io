...
<div class="blog-layout" markdown="0">
  ...
  <div class="blog-queue-section">
    <h2 class="blog-queue-heading">In the queue</h2>
    <p class="blog-queue-intro">Drafted or outlined — not promises, just what’s next when there’s time to write.</p>
    <div class="blog-post-row pr-blog-soon">
      <span class="post-date">Queued</span>
      <div>
        <h3>The 10ms lie we all tell</h3>
        <p>“We’ll optimize later” — until the product is built on synchronous Postgres. Why cache discipline is architecture, not a tuning pass.</p>
      </div>
    ...
    <div class="blog-post-row pr-blog-soon">
      ...
      <div>
        ...
        <p>Convention over configuration vs explicit boundaries — which instincts from fifteen years of Ruby carried straight into Astra’s actor tree.</p>
      </div>
