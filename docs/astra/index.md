...
An **operating system for autonomous agents** — microkernel, actor runtime, task graph, scheduling, memory, LLM routing. Not a framework.

The full wiki (architecture, reference, runbooks, deployment) lives here:
